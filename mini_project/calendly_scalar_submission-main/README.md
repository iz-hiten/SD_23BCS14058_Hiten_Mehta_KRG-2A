...
- **For Spring Boot backend:** Java 8+ (optional)
...
#### Option A: Spring Boot Backend (Java) - **RECOMMENDED**
...
#### Option B: Node.js Backend (TypeScript)
...
| Backend | Language | Port | Command |
|---------|----------|------|---------|
| **Spring Boot** | Java 8+ | 8081 | `.\start-spring.cmd` |
| **Node.js** | TypeScript | 3000 | `.\start-node.cmd` |

Both backends include:
- ✅ Health check API
- ✅ Token Bucket Rate Limiter (System Design)
- ✅ Static file serving
- ✅ CORS configuration
- ✅ Production-ready

**See [BACKEND_SWITCH.md](BACKEND_SWITCH.md) for detailed comparison and switching guide.**
