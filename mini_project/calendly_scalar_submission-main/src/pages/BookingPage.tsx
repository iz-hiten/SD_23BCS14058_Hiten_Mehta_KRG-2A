  ...
  return (
    <div className="min-h-screen bg-[#f2f2f2] py-12 px-4 flex items-center justify-center">
      <div className={cn(
        ...
        <div className={cn(
          "md:w-[360px] p-5 md:p-8 border-b md:border-b-0 md:border-r border-gray-200 bg-white",
          step === 'success' && "hidden"
        )}>
        ...
        <div className="flex-1 bg-white">
          {step === 'date' && (
            <div className="p-4 md:p-8 flex flex-col lg:flex-row gap-6 md:gap-8 min-h-[500px]">
